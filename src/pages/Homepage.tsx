            ...
            <div className="d-flex">
              ...
              <div className="content">
                <div>
                  ...
                  <small>
                    At Kwikstarter, we will offer an onboarding experience like
                    no other for projects and assist in the nurturing stages of
                    their listing and continue to offer that support mechanism
                    through to market creation on Kwikswap.
                  </small>
                </div>
                <div>
                  <h4>What’s in it for KWIK Token holders?</h4>
                  <h5>
                    KWIK Token holders will not only be able to take a role in
                    the governance of Kwikswap DEX, but also play an integral
                    part of fielding ONLY THE BEST projects onto the Kwikstarter
                    Launchpad.
                  </h5>
                </div>
              </div>
            ...
            <div className="d-flex">
              <div className="content content-full">
                <div>
                  ...
                  <h5>
                    Every Project will feature an allocation and will launch
                    over two Sales Stages. To participate in the launchpad sales
                    stages, contributors must hold a minimum of 1000 KWIK Tokens
                    to be whitelisted.
                  </h5>
                  <small>
                    We will ensures that everyone that whitelists in the
                    required time frame will receive a token allocation.
                  </small>
                </div>
                <div>
                  <h4>How does a punter join Kwikstarter?</h4>
                  <h5>
                    Firstly it is a requirement that prospective contributors
                    hold KWIK Tokens. Another value add of holding KWIK Tokens
                    is that holders/stokers appreciate a solid 12% APY staking
                    reward that is paid monthly.
                  </h5>
                </div>
              </div>
            </div>
        ...
        <div className="container">
          <div className="tiered-system">
            <div className="main-heading">
              ...
              <h5>
                We have a series of tiered levels at Kwikstarter, each
                containing their own unique benefits as set out below:
              </h5>
            </div>
                ...
                <ul className="cards">
                  <li className="card">
                    ...
                    <div className="card-carousel">
                      ...
                      <button className="time-limit stakeNow">Stake Now</button>
                      <button className="time-limit Approve" disabled>
                        Approve
                      </button>
                    </div>
                  </li>
                  <li className="card">
                    <img src={rockettwo} alt="rocket" />
                    <div className="card-carousel">
                      <div className="square-box">
